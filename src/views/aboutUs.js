    ...
    <div className=''>
      ...
      <section className='bg-gradient-to-b from-white to-orange-300 p-10'>
        <div className="w-32 h-28 ml-24">
          ...
          <div className="absolute mt-3">
            <div className="text-yellow-900 text-2xl font-normal">Know <br /></div>
            <div className="text-yellow-900 text-2xl font-bold">our history<br /></div></div>
        </div>
        ...
        <div className="mt-24 mb-12 text-center">
          <div className="w-80 h-10 block mx-auto">
            <div className="text-white text-3xl font-bold">Our Success</div>
            <div className="text-white text-3xl font-normal"> Numbers<br /></div>
          </div>
        </div>
        <div>
            ...
            <div class="flex justify-center bg-orange-400 h-auto w-fit rounded-2xl">
              <div className="flex justify-center py-7 px-32">
                <div class="flex flex-col justify-center mr-24">
                  ...
                  <div className="text-white text-5xl font-extrabold mb-7">6,500,00</div>
                  <div className="text-white text-xl font-normal">Total meals served</div>
                </div>
                ...
                <div class="flex flex-col justify-center mx-24">
                  ...
                  <div className="text-white text-5xl font-extrabold">+1,000</div>
                  <div className="text-center text-white text-xl font-normal">Average start review.<br />4,5 stars</div>              </div>
                <div className="origin-top-bot border border-stone-400"></div>
                <div class="flex flex-col justify-center ml-24">
                  ...
                  <div className="text-white text-5xl font-extrabold">+20,000</div>
                  <div className="text-center text-white text-xl font-normal">Number of clients<br />served</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="mt-10 bg-center p-10">
        ...
        <div className="w-32 h-28 ml-24">
          <div className="w-24 h-px absolute border-2 border-orange-300"></div>
          <div className="absolute mt-3">
            <div className="text-yellow-900 text-2xl font-normal">Our<br /></div>
            <div className="text-yellow-900 text-2xl font-bold">Vision<br /></div></div>
        </div>
            ...
            <div className="flex justify-center w-fit h-fit bg-orange-100 rounded-lg transform translate-x-20">
              <div className="flex flex-col w-80 m-2 justify-center">
                <div className="flex items-center">
                  ...
                  <div className="flex flex-row justify-center text-center text-yellow-900 text-2xl font-semibold">Reach the goals<br /></div>
                </div>
                <div>
                  <div className="mt-4 text-justify text-neutral-600 text-base font-normal">Throughout your journey, our service provides unwavering support, offering personalized guidance to help you efficiently reach your goals. By prioritizing your well-being and fostering self-confidence, we are dedicated to ensuring your success.</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex justify-center w-fit h-fit bg-orange-100 rounded-lg">
              <div className="flex flex-col w-80 m-2 justify-center">
                <div className="flex items-center">
                  ...
                  <div className="flex flex-row justify-center text-center text-yellow-900 text-2xl font-semibold">Save time<br /></div>
                </div>
                <div>
                  <div className="mt-4 text-justify text-neutral-600 text-base font-normal">We take care of the entire process, from meal preparation to packaging and doorstep delivery, allowing you to save both time and money. This way, you can dedicate more precious moments to your loved ones.</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center w-fit bg-orange-100 rounded-lg">
            <div className="flex flex-col w-80 m-2 justify-center">
              <div className="flex items-center">
                ...
                <div className="flex flex-row justify-center text-center text-yellow-900 text-2xl font-semibold">Best performances<br /></div>
              </div>
              <div>
                <div className="mt-4 text-justify text-neutral-600 text-base font-normal">At the core of our mission is the optimization of your time, physical vitality, and mental energy, enabling you to concentrate more effectively on your objectives and excel in your professional endeavors.</div>
              </div>
            </div>
          </div>
        </div> */}
      ...
      <section class="mt-10 p-10">
        <div className="w-32 h-28 ml-24">
          ...
          <div className="absolute mt-3">
            <div className="text-yellow-900 text-2xl font-normal">Our<br /></div>
            <div className="text-yellow-900 text-2xl font-bold">Departement<br /></div></div>
        </div>
      ...
      <section class="mt-10 p-10">
        <div className="w-32 h-28 ml-24">
          ...
          <div className="absolute mt-3">
            <div className="text-yellow-900 text-2xl font-normal">Our<br /></div>
            <div className="text-yellow-900 text-2xl font-bold">Our Differentials<br /></div></div>
        </div>
        <div className="flex flex-row px-16 ml-12 justify-between">
          <div className="flex flex-col h-[645px] bg-orange-100 rounded-2xl">
            <div className="my-4 mx-9 w-64">
          ...
          <div className="flex flex-col h-[645px] bg-orange-100 rounded-2xl">
            <div className="my-4 mx-9 w-64">
              ...
              <div className="mt-2">
                <div className="w-96"><div className="text-stone-800 text-2xl font-bold">Special</div>
                  <div className="text-yellow-900 text-2xl font-bold">Customer Experience</div>
                </div>
              </div>
              <div className="w-64 h-px absolute border-2 border-orange-300 mt-4">
                <div className="w-64 mt-4 text-justify text-zinc-500 text-normal font-normal leading-tight">Elevate your customer experience with our commitment to using only the finest, premium-quality ingredients in our bakery products. We go beyond ordinary by emphasizing the meticulous sourcing and superior quality of our raw materials, accentuating the exceptional taste and nutritional value of every treat. Our dedication to artisanal craftsmanship is evident in our use of both traditional techniques, passed down through generations, and innovative processes that set us apart. By sharing the captivating stories behind our creations, we aim to build transparency, foster trust, and cultivate a deeper appreciation for the unique artistry infused into each delightful confection, making your experience truly unforgettable.</div>
              </div>
            </div>
          </div>
        </div>
